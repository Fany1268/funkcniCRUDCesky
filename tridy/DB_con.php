...
/*
 * definovat funkci construct viz níže
 */
...
class DB_con {
    ...
    /*
     * nadefinovat hostname, username, password a samozřejmě název aktuálně používané databáze
     */
    function __construct() {
        $conn = mysqli_connect('127.0.0.1', 'root', '', 'database_users');
        $this->dbcon = $conn;
    ...
    /*
     * v dotazu nezapomenout přepsat název aktuální tabulky
     */
